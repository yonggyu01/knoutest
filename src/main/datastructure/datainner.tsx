...
따라서 레지스터 주소지정방식에서는 AC에 400이 적재됩니다
    ...
    const test2019unix : Testtype[] = [
        ...
        {//51 ???
            ...
            a : ["디렉터리 backup에 있는 파일들을 기존 아카이브 bar.tar의 끝에 추가함","아카이브 bar.tar에 있는 파일 목록과 디렉터리 backup에 있는 파일 목록을 함께 출력함","아카이브 bar.tar에 있는 파일들을 디렉터리 backup에 있는 파이들을 묶어 새로운 아카이브 bar.tar를 만듦"],
            r : 4,
            img:'',
